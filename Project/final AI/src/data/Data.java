...
public class Data {
    ...
    static GiaoVien gv1 = new GiaoVien("GV001", "Giao vien A", List.of(toan), 3);
    static GiaoVien gv2 = new GiaoVien("GV002", "Giao vien B", List.of(toan), 3);
    static GiaoVien gv3 = new GiaoVien("GV003", "Giao vien C", List.of(van), 3);
    static GiaoVien gv4 = new GiaoVien("GV004", "Giao vien D", List.of(van), 3);
    static GiaoVien gv5 = new GiaoVien("GV005", "Giao vien E", List.of(anh), 3);
    static GiaoVien gv6 = new GiaoVien("GV006", "Giao vien F", List.of(anh), 3);
    static GiaoVien gv7 = new GiaoVien("GV007", "Giao vien G", List.of(ly), 3);
    static GiaoVien gv8 = new GiaoVien("GV005", "Giao vien H", List.of(ly), 3);
    static GiaoVien gv9 = new GiaoVien("GV005", "Giao vien I", List.of(hoa), 3);
    static GiaoVien gv10 = new GiaoVien("GV005", "Giao vien J", List.of(hoa), 3);
